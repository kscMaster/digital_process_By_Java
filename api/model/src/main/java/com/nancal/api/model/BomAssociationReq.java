...
@ApiModel(value = "Bom关联关系的请求")
@Data
@NoArgsConstructor
public class BomAssociationReq {
    @ApiModelProperty(value = "bom行uid用于判断是否是顶层",required = true)
    ...
    @ApiModelProperty(value = "选中数据的参数",required = true)
