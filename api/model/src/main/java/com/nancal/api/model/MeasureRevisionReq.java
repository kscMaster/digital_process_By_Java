...
@ApiModel(value = "MeasureRevision 量具版本 的请求")
@Data

@NoArgsConstructor
public class MeasureRevisionReq extends MsgbImportReq  implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MeasureRevisionEntity)) {
            return false;
        }
        MeasureRevisionEntity that = (MeasureRevisionEntity) o;
        return StrUtil.equals(StrUtil.blankToDefault(specification,StrUtil.EMPTY), that.getSpecification())
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), specification, objectName,itemId);
    }
}