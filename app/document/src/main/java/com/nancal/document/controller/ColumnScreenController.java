...
public class ColumnScreenController {
    ...
    public Response<ColumnScreenResp> find(String objectType) {
        return Response.of(service.find(AppNameEnum.DOCUMENTBOM,objectType));
    }

    @ApiOperation(value = "编辑")
    @PostMapping(value = "/update")
    public Response<BusinessObjectResp> update(@RequestBody @Validated(AddGroup.class) ColumnScreenReq req) {
        req.setAppName(AppNameEnum.DOCUMENTBOM);
