...
@Service("gte4WorklineRevisionDomainServiceImpl")
public class Gte4WorklineRevisionDomainServiceImpl implements IGte4WorklineRevisionDomainService {
...
//        根据工序零件uid获取最大版本最新激活的版本uid
        ...
        WorkspaceObjectResp objectResp = (WorkspaceObjectResp) IGte4WorklineRevisionDomainService.super.getObject(new IdRequest(lastVersion.getUid()));
    ...
    public BusinessObjectResp update(BusinessObjectReq req) {
        ...
        if (!Objects.isNull(operationBomReq.getWorklineRevisionReq())) {
            //调用编辑工步属性方法
            WorkspaceObjectResp update = (WorkspaceObjectResp) IGte4WorklineRevisionDomainService.super.update(operationBomReq.getWorklineRevisionReq());
