...
@Service
@Slf4j
public class MeasureImportServiceImpl extends CustomFieldPoiWordAnalysis<LibraryAttributeMeasureReq> implements IImexportServiceAdaptor {
    ...
    public Response<Gte4ImportRevisionResp> importExcel(String leftObject, String  leftObjectType,String uid, TokenInfo tokenInfo ){
        try {
            ...
            analysis.forEach(revisionReq ->{
                ...
                equipmentRevisionReq.setObjectType(new MeasureEntity().getObjectType());
                WorkspaceObjectResp insert = this.save(equipmentRevisionReq);
