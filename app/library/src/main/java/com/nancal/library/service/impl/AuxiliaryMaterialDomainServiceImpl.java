...
@Service
@Slf4j
public class AuxiliaryMaterialDomainServiceImpl extends CustomFieldPoiWordAnalysis<LibraryAttributeAuxiliaryReq> implements IAuxiliaryMaterialDomainService, IItemDomainServiceAdaptor {

    @Autowired
    private AuxiliaryMaterialDomainServiceImpl auxiliaryMaterialDomainService;
    ...
    public WorkspaceObjectResp save(BusinessObjectReq req) {
        ...
        WorkspaceObjectResp save = IItemDomainServiceAdaptor.super.save(auxiliaryMaterialReq.getAuxiliaryMaterialRevisionReq());
    ...
    public void exportExcelModel(HttpServletResponse request){
        ...
        ExportExcelUtil.customExportExcels(request,required,titles,"资源库模板-辅材");
    }
    ...
    public TableResponse<List<Map<String,Object>>> customPage(TableRequest<? extends ItemRevisionReq> req){
        TableResponse<WorkspaceObjectResp> response = IAuxiliaryMaterialDomainService.super.pagePlus(req);
    ...
    public Response<Gte4ImportRevisionResp> importExcel(MultipartFile file, String leftObjec, String  leftObjectType, boolean isExcel){
        ...
        List<List<LibraryAttributeAuxiliaryReq>> split = CollUtil.split(analysis, 1);
        ...
        split.forEach(l ->{
            CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
                l.forEach(revisionReq ->{
                    ...
                    WorkspaceObjectResp insert = auxiliaryMaterialDomainService.insert(revisionReq.getAuxiliaryMaterialRevisionReq());
        ...
        auxiliaryMaterialDomainService.statistics(leftObjectType,leftObjec,atomicInteger.get());
        return Response.of();
    }
