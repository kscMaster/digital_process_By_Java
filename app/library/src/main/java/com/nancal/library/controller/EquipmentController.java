...
public class EquipmentController {
    ...
    @Qualifier("equipmentDomainServiceImpl")
    @Autowired
    private IEquipmentDomainService service;
    @Qualifier("equipmentDomainServiceImpl")

    @ApiOperation(value = "新增")
    @PreAuthorize
    @PostMapping(value = "/create")
    public Response<BusinessObjectResp> create(@RequestBody @Validated(AddGroup.class) LibraryAttributeEquipmentReq req) {
