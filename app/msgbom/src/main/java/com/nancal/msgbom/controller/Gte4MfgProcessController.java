...
public class Gte4MfgProcessController {
    ...
    @Autowired
    private IGte4CnstrProcessDomainService iGte4CnstrProcessDomainService;
    ...
    @PreAuthorize
    @ApiOperation(value = "克隆工艺规程")
    @PostMapping("/cloneProcess")
    public Response<BusinessObjectResp> cloneProcess(@RequestBody @Validated(AddGroup.class) Gte4MfgProcessCloneReq req) {
        return Response.of(service.cloneProcess(req));
    }
    ...
    @ApiOperation(value = "生成随工工艺规程")
    @PostMapping(value = "/generateFollowMsgBom")
    public Response<BusinessObjectResp> generateFollowMsgBom(@RequestBody @Validated GenerateFollowMsgBomReq req) {
        return Response.of(iGte4CnstrProcessDomainService.generateFollowMsgBom(req));
    }
